    ...
    <div class="max-w-full ">
        ...
        @else
            <div class="mb-5 flex w-full items-center gap-4">
                ...
                <button wire:click="toggleWorkday"
                    class="bg-emerald-400/60 w-full sm:w-40 sm:ml-4 mt-2 sm:mt-0 shadow text-emerald-700 font-medium rounded-lg text-sm py-2.5 px-4 text-center inline-flex items-center transition-colors duration-300 ease-in-out">
                    <span class="material-symbols-outlined mr-3">work_history</span>
                    Iniciar jornada
                </button>
            </div>
